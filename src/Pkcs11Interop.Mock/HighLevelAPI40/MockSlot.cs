...
namespace Net.Pkcs11Interop.Mock.HighLevelAPI40
{
    ...
    /// </summary>
    public class MockSlot : Net.Pkcs11Interop.HighLevelAPI40.Slot, IMockSlot
    {
        /// <summary>
        ...
        internal MockSlot(Pkcs11InteropFactories factories, LowLevelAPI40.MockPkcs11Library pkcs11Library, ulong slotId)
        ...
        public void EjectToken()
        {
            ...
            CKR rv = ((LowLevelAPI40.MockPkcs11Library)_pkcs11Library).C_EjectToken(_slotId);
            if (rv != CKR.CKR_OK)
