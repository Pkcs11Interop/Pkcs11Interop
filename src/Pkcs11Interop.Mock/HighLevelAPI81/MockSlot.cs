...
namespace Net.Pkcs11Interop.Mock.HighLevelAPI81
{
    ...
    public class MockSlot : Net.Pkcs11Interop.HighLevelAPI81.Slot, IMockSlot
    {
        ...
        internal MockSlot(Pkcs11InteropFactories factories, LowLevelAPI81.MockPkcs11Library pkcs11, ulong slotId)
        ...
        public void EjectToken()
        {
            ...
            CKR rv = ((LowLevelAPI81.MockPkcs11Library)_p11).C_EjectToken(_slotId);
            if (rv != CKR.CKR_OK)
