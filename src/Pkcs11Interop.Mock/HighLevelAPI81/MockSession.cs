...
namespace Net.Pkcs11Interop.Mock.HighLevelAPI81
{
    ...
    public class MockSession : Net.Pkcs11Interop.HighLevelAPI81.Session, IMockSession
    {
        ...
        internal MockSession(Pkcs11InteropFactories factories, LowLevelAPI81.MockPkcs11Library pkcs11Library, ulong sessionId)
        ...
        public void InteractiveLogin()
        {
            ...
            CKR rv = ((LowLevelAPI81.MockPkcs11Library)_pkcs11Library).C_InteractiveLogin(_sessionId);
            if (rv != CKR.CKR_OK)
