...
namespace Net.Pkcs11Interop.Mock.HighLevelAPI80
{
    ...
    public class MockSlot : Net.Pkcs11Interop.HighLevelAPI80.Slot, IMockSlot
    {
        ...
        internal MockSlot(Pkcs11InteropFactories factories, LowLevelAPI80.MockPkcs11Library pkcs11Library, ulong slotId)
        ...
        public void EjectToken()
        {
            ...
            CKR rv = ((LowLevelAPI80.MockPkcs11Library)_pkcs11Library).C_EjectToken(_slotId);
            if (rv != CKR.CKR_OK)
