...
namespace Net.Pkcs11Interop.Tests.HighLevelAPI
{
    ...
    public class _01_InitializeTest
    {
        ...
        public void _01_BasicPkcs11DisposeTest()
        {
            ...
            IPkcs11Library pkcs11 = Settings.Factories.Pkcs11Factory.CreatePkcs11(Settings.Factories, Settings.Pkcs11LibraryPath, Settings.AppType);
        ...
        public void _03_SingleThreadedInitializeTest()
        {
            ...
            using (IPkcs11Library pkcs11 = Settings.Factories.Pkcs11Factory.CreatePkcs11(Settings.Factories, Settings.Pkcs11LibraryPath, AppType.SingleThreaded))
            {
                // Do something interesting
            }
        }
        ...
        public void _04_MultiThreadedInitializeTest()
        {
            ...
            using (IPkcs11Library pkcs11 = Settings.Factories.Pkcs11Factory.CreatePkcs11(Settings.Factories, Settings.Pkcs11LibraryPath, AppType.MultiThreaded))
            {
                // Do something interesting
            }
        }
        ...
        public void _05_Pkcs11WithGetFunctionListTest()
        {
            ...
            using (IPkcs11Library pkcs11 = Settings.Factories.Pkcs11Factory.CreatePkcs11(Settings.Factories, Settings.Pkcs11LibraryPath, Settings.AppType, InitType.WithFunctionList))
            {
                // Do something interesting
            }
        }
        ...
        public void _06_Pkcs11WithoutGetFunctionListTest()
        {
            ...
            // This can be done either via C_GetFunctionList() function or via platform specific native function - GetProcAddress() on Windows and dlsym() on Unix.
            // InitType enum can be used to specify which approach should be used.
            using (IPkcs11Library pkcs11 = Settings.Factories.Pkcs11Factory.CreatePkcs11(Settings.Factories, Settings.Pkcs11LibraryPath, Settings.AppType, InitType.WithoutFunctionList))
            {
                // Do something interesting
            }
        }
