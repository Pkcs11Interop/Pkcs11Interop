    ...
    public class _11_SeedAndGenerateRandomTest
    {
        ...
        public void _01_SeedRandomTest()
        {
            ...
            using (Pkcs11Library pkcs11Library = new Pkcs11Library(Settings.Pkcs11LibraryPath))
            {
                ...
                rv = pkcs11Library.C_SeedRandom(session, seed, ConvertUtils.UInt32FromInt32(seed.Length));
                if (rv != CKR.CKR_OK)
                    Assert.Fail(rv.ToString());
        ...
        public void _02_GenerateRandomTest()
        {
            ...
            using (Pkcs11Library pkcs11Library = new Pkcs11Library(Settings.Pkcs11LibraryPath))
            {
                ...
                rv = pkcs11Library.C_GenerateRandom(session, randomData, ConvertUtils.UInt32FromInt32(randomData.Length));
                if (rv != CKR.CKR_OK)
                    Assert.Fail(rv.ToString());
