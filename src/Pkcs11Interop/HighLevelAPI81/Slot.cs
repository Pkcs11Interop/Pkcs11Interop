...
namespace Net.Pkcs11Interop.HighLevelAPI81
{
    ...
    public class Slot : ISlot
    {
        ...
        /// </summary>
        private static Pkcs11InteropLogger _logger = Pkcs11InteropLoggerFactory.GetLogger(typeof(Slot));
        ...
        protected internal Slot(Pkcs11InteropFactories factories, LowLevelAPI81.Pkcs11Library pkcs11, ulong slotId)
        {
