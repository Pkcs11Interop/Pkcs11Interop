...
namespace Net.Pkcs11Interop.HighLevelAPI81.MechanismParams
{
    ...
    public class CkCamelliaCbcEncryptDataParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI81.MechanismParams.CK_CAMELLIA_CBC_ENCRYPT_DATA_PARAMS _lowLevelStruct = new LowLevelAPI81.MechanismParams.CK_CAMELLIA_CBC_ENCRYPT_DATA_PARAMS();
