...
namespace Net.Pkcs11Interop.HighLevelAPI40.MechanismParams
{
    ...
    public class CkAriaCbcEncryptDataParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI40.MechanismParams.CK_ARIA_CBC_ENCRYPT_DATA_PARAMS _lowLevelStruct = new LowLevelAPI40.MechanismParams.CK_ARIA_CBC_ENCRYPT_DATA_PARAMS();
