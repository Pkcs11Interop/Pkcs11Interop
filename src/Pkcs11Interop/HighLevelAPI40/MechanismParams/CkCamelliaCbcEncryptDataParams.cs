...
namespace Net.Pkcs11Interop.HighLevelAPI40.MechanismParams
{
    ...
    public class CkCamelliaCbcEncryptDataParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI40.MechanismParams.CK_CAMELLIA_CBC_ENCRYPT_DATA_PARAMS _lowLevelStruct = new LowLevelAPI40.MechanismParams.CK_CAMELLIA_CBC_ENCRYPT_DATA_PARAMS();
