...
namespace Net.Pkcs11Interop.HighLevelAPI40
{
    ...
    public class ObjectAttribute : IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI40.CK_ATTRIBUTE _ckAttribute;

        /// <summary>
        /// Low level attribute structure
        /// </summary>
        internal LowLevelAPI40.CK_ATTRIBUTE CkAttribute
        {
            get
            {
                if (this._disposed)
        ...
        internal ObjectAttribute(LowLevelAPI40.CK_ATTRIBUTE attribute)
        {
        ...
        {
            _ckAttribute = LowLevelAPI40.CkaUtils.CreateAttribute(type);
        }
        ...
        {
            _ckAttribute = LowLevelAPI40.CkaUtils.CreateAttribute(type, value);
        }
        ...
        public uint GetValueAsUint()
        {
            ...
            uint value = 0;
            LowLevelAPI40.CkaUtils.ConvertValue(ref _ckAttribute, out value);
            return value;
        }
        ...
        {
            LowLevelAPI40.CK_ATTRIBUTE[] attributes = null;

            if (value != null)
            {
                attributes = new LowLevelAPI40.CK_ATTRIBUTE[value.Count];
            ...
            _ckAttribute = LowLevelAPI40.CkaUtils.CreateAttribute(type, attributes);
        }
        ...
        public List<ObjectAttribute> GetValueAsObjectAttributeList()
        {
            ...
            LowLevelAPI40.CK_ATTRIBUTE[] value = null;
            LowLevelAPI40.CkaUtils.ConvertValue(ref _ckAttribute, out value);
        ...
        public ObjectAttribute(uint type, List<uint> value)
        {
            ...
            _ckAttribute = LowLevelAPI40.CkaUtils.CreateAttribute(type, uints);
        }
        ...
        public ObjectAttribute(uint type, List<CKM> value)
        {
            ...
            _ckAttribute = LowLevelAPI40.CkaUtils.CreateAttribute(type, mechanisms);
        }
