    ...
    public class Pkcs11Library : IPkcs11Library
    {
            ...
            : this(factories, libraryPath)
        {
            ...
            try
            {
                ...
                _pkcs11Library = new LowLevelAPI40.Pkcs11Library(_libraryPath);
                Initialize(appType);
            }
            catch
            {
            ...
            : this(factories, libraryPath)
        {
            ...
            {
                _logger.Info("Loading PKCS#11 library {0}", _libraryPath);
                _pkcs11Library = new LowLevelAPI40.Pkcs11Library(_libraryPath, (initType == InitType.WithFunctionList));
                Initialize(appType);
            }
            catch
            {
