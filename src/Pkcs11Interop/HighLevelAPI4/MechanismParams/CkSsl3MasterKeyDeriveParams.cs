...
namespace Net.Pkcs11Interop.HighLevelAPI4.MechanismParams
{
    ...
    public class CkSsl3MasterKeyDeriveParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI4.MechanismParams.CK_SSL3_MASTER_KEY_DERIVE_PARAMS _lowLevelStruct = new LowLevelAPI4.MechanismParams.CK_SSL3_MASTER_KEY_DERIVE_PARAMS();
