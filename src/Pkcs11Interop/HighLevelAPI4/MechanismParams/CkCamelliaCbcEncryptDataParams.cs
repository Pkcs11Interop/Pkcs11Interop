...
namespace Net.Pkcs11Interop.HighLevelAPI4.MechanismParams
{
    ...
    public class CkCamelliaCbcEncryptDataParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI4.MechanismParams.CK_CAMELLIA_CBC_ENCRYPT_DATA_PARAMS _lowLevelStruct = new LowLevelAPI4.MechanismParams.CK_CAMELLIA_CBC_ENCRYPT_DATA_PARAMS();
