...
namespace Net.Pkcs11Interop.HighLevelAPI41.MechanismParams
{
    ...
    public class CkWtlsKeyMatParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI41.MechanismParams.CK_WTLS_KEY_MAT_PARAMS _lowLevelStruct = new LowLevelAPI41.MechanismParams.CK_WTLS_KEY_MAT_PARAMS();
        ...
        public CkWtlsKeyMatParams(uint digestMechanism, uint macSizeInBits, uint keySizeInBits, uint ivSizeInBits, uint sequenceNumber, bool isExport, CkWtlsRandomData randomInfo)
        {
            ...
            // Abrakadabra :)
            _lowLevelStruct.ReturnedKeyMaterial = Common.UnmanagedMemory.Allocate(Common.UnmanagedMemory.SizeOf(typeof(CK_WTLS_KEY_MAT_OUT)));
