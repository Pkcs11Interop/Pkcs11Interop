...
namespace Net.Pkcs11Interop.Common
{
    ...
    public enum CKA : uint
    {
        ...
        /// <summary>
        /// The attribute template to match against any keys wrapped using this wrapping key. Keys that do not match cannot be wrapped. [List<ObjectAttribute>/CK_ATTRIBUTE array]
        /// </summary>
        CKA_WRAP_TEMPLATE = (CKF.CKF_ARRAY_ATTRIBUTE | 0x00000211),
        
        /// <summary>
        /// The attribute template to apply to any keys unwrapped using this wrapping key. Any user supplied template is applied after this template as if the object has already been created. [List<ObjectAttribute>/CK_ATTRIBUTE array]
        /// </summary>
        ...
        /// <summary>
        /// A list of mechanisms allowed to be used with this key [List<CKM>/List<uint>/CKM array/uint array]
        /// </summary>
