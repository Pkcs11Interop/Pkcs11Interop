...
namespace Net.Pkcs11Interop.HighLevelAPI.MechanismParams
{
    ...
    public class CkKeyDerivationStringData : IMechanismParams, IDisposable
    {
        ...
        /// Platform specific CkKeyDerivationStringData
        /// </summary>
        private HighLevelAPI81.MechanismParams.CkKeyDerivationStringData _params8 = null;
        ...
        public CkKeyDerivationStringData(byte[] data)
        {
            if (Platform.UnmanagedLongSize == 4)
                ...
                _params8 = new HighLevelAPI81.MechanismParams.CkKeyDerivationStringData(data);
        }
