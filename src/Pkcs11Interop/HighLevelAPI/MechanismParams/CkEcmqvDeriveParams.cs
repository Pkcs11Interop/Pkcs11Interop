...
namespace Net.Pkcs11Interop.HighLevelAPI.MechanismParams
{
    ...
    public class CkEcmqvDeriveParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private HighLevelAPI41.MechanismParams.CkEcmqvDeriveParams _params4 = null;

        /// <summary>
        /// Platform specific CkEcmqvDeriveParams
        /// </summary>
        private HighLevelAPI81.MechanismParams.CkEcmqvDeriveParams _params8 = null;
        ...
        public CkEcmqvDeriveParams(ulong kdf, byte[] sharedData, byte[] publicData, ulong privateDataLen, ObjectHandle privateData, byte[] publicData2, ObjectHandle publicKey)
        {
            if (Platform.UnmanagedLongSize == 4)
                _params4 = new HighLevelAPI41.MechanismParams.CkEcmqvDeriveParams(Convert.ToUInt32(kdf), sharedData, publicData, Convert.ToUInt32(privateDataLen), privateData.ObjectHandle41, publicData2, publicKey.ObjectHandle41);
            else
                _params8 = new HighLevelAPI81.MechanismParams.CkEcmqvDeriveParams(kdf, sharedData, publicData, privateDataLen, privateData.ObjectHandle81, publicData2, publicKey.ObjectHandle81);
        }
