...
namespace Net.Pkcs11Interop.HighLevelAPI.Factories
{
    ...
    public interface IPkcs11LibraryFactory
    {
        ...
        IPkcs11Library CreatePkcs11Library(Pkcs11InteropFactories factories, string libraryPath, AppType appType);
        ...
        /// <returns>High level PKCS#11 wrapper</returns>
        IPkcs11Library CreatePkcs11Library(Pkcs11InteropFactories factories, string libraryPath, AppType appType, InitType initType);
    }
}
