...
namespace Net.Pkcs11Interop.HighLevelAPI8.MechanismParams
{
    ...
    public class CkWtlsMasterKeyDeriveParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI8.MechanismParams.CK_WTLS_MASTER_KEY_DERIVE_PARAMS _lowLevelStruct = new LowLevelAPI8.MechanismParams.CK_WTLS_MASTER_KEY_DERIVE_PARAMS();
