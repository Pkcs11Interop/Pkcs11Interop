...
namespace Net.Pkcs11Interop.HighLevelAPI8.MechanismParams
{
    ...
    public class CkCamelliaCbcEncryptDataParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI8.MechanismParams.CK_CAMELLIA_CBC_ENCRYPT_DATA_PARAMS _lowLevelStruct = new LowLevelAPI8.MechanismParams.CK_CAMELLIA_CBC_ENCRYPT_DATA_PARAMS();
