...
namespace Net.Pkcs11Interop.LowLevelAPI41
{
    ...
    public static class CkmUtils
    {
        ...
        {
            return CreateMechanism(ConvertUtils.UInt32FromCKM(mechanism));
        }
        ...
        {
            return CreateMechanism(ConvertUtils.UInt32FromCKM(mechanism), parameter);
        }
        ...
        public static CK_MECHANISM CreateMechanism(CKM mechanism, object parameterStructure)
        {
            ...
            return CreateMechanism(ConvertUtils.UInt32FromCKM(mechanism), parameterStructure);
        }
        ...
        public static CK_MECHANISM CreateMechanism(NativeULong mechanism, object parameterStructure)
        {
            ...
            ckMechanism.ParameterLen = ConvertUtils.UInt32FromInt32(UnmanagedMemory.SizeOf(parameterStructure.GetType()));
        ...
        private static CK_MECHANISM _CreateMechanism(NativeULong mechanism, byte[] parameter)
        {
            ...
            if ((parameter != null) && (parameter.Length > 0))
            {
                ...
                mech.ParameterLen = ConvertUtils.UInt32FromInt32(parameter.Length);
            }
            else
            {
