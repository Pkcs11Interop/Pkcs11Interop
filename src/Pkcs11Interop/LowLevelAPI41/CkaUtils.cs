...
namespace Net.Pkcs11Interop.LowLevelAPI41
{
    ...
    public static class CkaUtils
    {
        ...
        {
            return CreateAttribute(ConvertUtils.UInt32FromCKA(type));
        }
        ...
        {
            return _CreateAttribute(type, ConvertUtils.UInt32ToBytes(value));
        }
        ...
        public static void ConvertValue(ref CK_ATTRIBUTE attribute, out NativeULong value)
        {
            ...
            value = ConvertUtils.UInt32FromBytes(bytes);
        }
        ...
        public static CK_ATTRIBUTE CreateAttribute(NativeULong type, CK_ATTRIBUTE[] value)
        {
            ...
            if ((value != null) && (value.Length > 0))
            {
                ...
                attribute.valueLen = ConvertUtils.UInt32FromInt32(ckAttributeSize * value.Length);
            }
            else
            {
        ...
        public static CK_ATTRIBUTE CreateAttribute(NativeULong type, NativeULong[] value)
        {
            ...
            if ((value != null) && (value.Length > 0))
            {
                ...
                for (int i = 0; i < value.Length; i++)
                {
                    ...
                    UnmanagedMemory.Write(tempPointer, ConvertUtils.UInt32ToBytes(value[i]));
                }
                attribute.valueLen = ConvertUtils.UInt32FromInt32(ckmSize * value.Length);
            }
            else
            {
                attribute.value = IntPtr.Zero;
        ...
        public static void ConvertValue(ref CK_ATTRIBUTE attribute, out NativeULong[] value)
        {
            ...
            else
            {
                ...
                {
                    IntPtr tempPointer = new IntPtr(attribute.value.ToInt64() + (i * ckmSize));
                    attrs[i] = ConvertUtils.UInt32FromBytes(UnmanagedMemory.Read(tempPointer, ckmSize));
                }
        ...
        public static CK_ATTRIBUTE CreateAttribute(CKA type, CKM[] value)
        {
            ...
            if (value != null)
            {
                ...
                for (int i = 0; i < value.Length; i++)
                    nativeULongArray[i] = ConvertUtils.UInt32FromCKM(value[i]);
            }
        ...
        public static void ConvertValue(ref CK_ATTRIBUTE attribute, out CKM[] value)
        {
            ...
            if (nativeULongArray != null)
            {
                ...
                for (int i = 0; i < nativeULongArray.Length; i++)
                    ckmArray[i] = ConvertUtils.UInt32ToCKM(nativeULongArray[i]);
            }
            value = ckmArray;
        }
        ...
        private static CK_ATTRIBUTE _CreateAttribute(NativeULong type, byte[] value)
        {
            ...
            if (value != null)
            {
                ...
                attribute.valueLen = ConvertUtils.UInt32FromInt32(value.Length);
            }
            else
            {
                attribute.value = IntPtr.Zero;
