...
using CK_KEY_DERIVATION_STRING_DATA = Net.Pkcs11Interop.LowLevelAPI80.MechanismParams.CK_KEY_DERIVATION_STRING_DATA;
using CK_MECHANISM = Net.Pkcs11Interop.LowLevelAPI80.CK_MECHANISM;
