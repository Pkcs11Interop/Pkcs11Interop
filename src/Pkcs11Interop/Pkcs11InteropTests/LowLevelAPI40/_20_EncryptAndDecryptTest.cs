    ...
    public class _20_EncryptAndDecryptTest
    {
        ...
        public void _01_EncryptAndDecryptSinglePartTest()
        {
            ...
            using (Pkcs11 pkcs11 = new Pkcs11(Settings.Pkcs11LibraryPath))
            {
                ...
                rv = pkcs11.C_Encrypt(session, sourceData, NativeULongUtils.ConvertUInt32FromInt32(sourceData.Length), null, ref encryptedDataLen);
                if (rv != CKR.CKR_OK)
                    Assert.Fail(rv.ToString());
                ...
                rv = pkcs11.C_Encrypt(session, sourceData, NativeULongUtils.ConvertUInt32FromInt32(sourceData.Length), encryptedData, ref encryptedDataLen);
                if (rv != CKR.CKR_OK)
                    Assert.Fail(rv.ToString());
                ...
                rv = pkcs11.C_Decrypt(session, encryptedData, NativeULongUtils.ConvertUInt32FromInt32(encryptedData.Length), null, ref decryptedDataLen);
                if (rv != CKR.CKR_OK)
                    Assert.Fail(rv.ToString());
                ...
                rv = pkcs11.C_Decrypt(session, encryptedData, NativeULongUtils.ConvertUInt32FromInt32(encryptedData.Length), decryptedData, ref decryptedDataLen);
                if (rv != CKR.CKR_OK)
                    Assert.Fail(rv.ToString());
            ...
            using (Pkcs11 pkcs11 = new Pkcs11(Settings.Pkcs11LibraryPath))
            {
                ...
                using (MemoryStream inputStream = new MemoryStream(sourceData), outputStream = new MemoryStream())
                {
                    ...
                    while ((bytesRead = inputStream.Read(part, 0, part.Length)) > 0)
                    {
                        ...
                        rv = pkcs11.C_EncryptUpdate(session, part, NativeULongUtils.ConvertUInt32FromInt32(bytesRead), encryptedPart, ref encryptedPartLen);
                        if (rv != CKR.CKR_OK)
                            Assert.Fail(rv.ToString());
                ...
                using (MemoryStream inputStream = new MemoryStream(encryptedData), outputStream = new MemoryStream())
                {
                    ...
                    while ((bytesRead = inputStream.Read(encryptedPart, 0, encryptedPart.Length)) > 0)
                    {
                        ...
                        rv = pkcs11.C_DecryptUpdate(session, encryptedPart, NativeULongUtils.ConvertUInt32FromInt32(bytesRead), part, ref partLen);
                        if (rv != CKR.CKR_OK)
                            Assert.Fail(rv.ToString());
        ...
        public void _03_EncryptAndDecryptSinglePartOaepTest()
        {
            ...
            using (Pkcs11 pkcs11 = new Pkcs11(Settings.Pkcs11LibraryPath))
            {
                ...
                mechanismParams.HashAlg = NativeULongUtils.ConvertUInt32FromCKM(CKM.CKM_SHA_1);
                mechanismParams.Mgf = NativeULongUtils.ConvertUInt32FromCKG(CKG.CKG_MGF1_SHA1);
                mechanismParams.Source = NativeULongUtils.ConvertUInt32FromUInt32(CKZ.CKZ_DATA_SPECIFIED);
