...
namespace Net.Pkcs11Interop.Tests.HighLevelAPI40
{
    ...
    public class _14_MechanismTest
    {
        ...
        public void _02_EmptyParameterTest()
        {
            ...
            Net.Pkcs11Interop.LowLevelAPI40.CK_MECHANISM ckMechanism = (Net.Pkcs11Interop.LowLevelAPI40.CK_MECHANISM)typeof(Mechanism).GetField("_ckMechanism", BindingFlags.NonPublic | BindingFlags.Instance).GetValue(mechanism);
        ...
        public void _03_ByteArrayParameterTest()
        {
            ...
            // We access private Mechanism member here just for the testing purposes
            ckMechanism = (Net.Pkcs11Interop.LowLevelAPI40.CK_MECHANISM)typeof(Mechanism).GetField("_ckMechanism", BindingFlags.NonPublic | BindingFlags.Instance).GetValue(mechanism);
            Assert.IsTrue(ckMechanism.Mechanism == (uint)CKM.CKM_AES_CBC);
            Assert.IsTrue(ckMechanism.Parameter == IntPtr.Zero);
            Assert.IsTrue(ckMechanism.ParameterLen == 0);
        }
        ...
        public void _04_ObjectParameterTest()
        {
            ...
            Assert.IsTrue(ckMechanism.Parameter != IntPtr.Zero);
            Assert.IsTrue(ckMechanism.ParameterLen == Net.Pkcs11Interop.Common.UnmanagedMemory.SizeOf(typeof(Net.Pkcs11Interop.LowLevelAPI40.MechanismParams.CK_KEY_DERIVATION_STRING_DATA)));
        }
    }
}
