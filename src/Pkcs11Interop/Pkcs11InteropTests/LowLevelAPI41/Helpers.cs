...
namespace Net.Pkcs11Interop.Tests.LowLevelAPI41
{
    ...
    public static class Helpers
    {
        ...
        public static CKR CreateDataObject(Pkcs11 pkcs11, NativeULong session, ref NativeULong objectId)
        {
            ...
            // Create object
            rv = pkcs11.C_CreateObject(session, template, NativeULongUtils.GetUInt32FromInt32(template.Length), ref objectId);
        ...
        public static CKR GenerateKey(Pkcs11 pkcs11, NativeULong session, ref NativeULong keyId)
        {
            ...
            // Generate key
            rv = pkcs11.C_GenerateKey(session, ref mechanism, template, NativeULongUtils.GetUInt32FromInt32(template.Length), ref keyId);
        ...
        public static CKR GenerateKeyPair(Pkcs11 pkcs11, NativeULong session, ref NativeULong pubKeyId, ref NativeULong privKeyId)
        {
            ...
            rv = pkcs11.C_GenerateRandom(session, ckaId, NativeULongUtils.GetUInt32FromInt32(ckaId.Length));
            if (rv != CKR.CKR_OK)
                return rv;
            ...
            // Generate key pair
            rv = pkcs11.C_GenerateKeyPair(session, ref mechanism, pubKeyTemplate, NativeULongUtils.GetUInt32FromInt32(pubKeyTemplate.Length), privKeyTemplate, NativeULongUtils.GetUInt32FromInt32(privKeyTemplate.Length), ref pubKeyId, ref privKeyId);
