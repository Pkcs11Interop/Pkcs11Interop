...
namespace Net.Pkcs11Interop.Tests.LowLevelAPI41
{
    ...
    public class _14_ObjectAttributeTest
    {
        ...
        public void _01_EmptyAttributeTest()
        {
            ...
            Assert.IsTrue(attr.type == NativeULongUtils.ConvertUInt32FromCKA(CKA.CKA_CLASS));
        ...
        public void _02_UintAttributeTest()
        {
            ...
            NativeULong originalValue = NativeULongUtils.ConvertUInt32FromCKO(CKO.CKO_DATA);
            // Create attribute with NativeULong value
            CK_ATTRIBUTE attr = CkaUtils.CreateAttribute(CKA.CKA_CLASS, originalValue);
            Assert.IsTrue(attr.type == NativeULongUtils.ConvertUInt32FromCKA(CKA.CKA_CLASS));
            Assert.IsTrue(attr.value != IntPtr.Zero);
            Assert.IsTrue(attr.valueLen == NativeULongUtils.ConvertUInt32FromInt32(UnmanagedMemory.SizeOf(typeof(NativeULong))));
        ...
        public void _03_BoolAttributeTest()
        {
            ...
            Assert.IsTrue(attr.type == NativeULongUtils.ConvertUInt32FromCKA(CKA.CKA_TOKEN));
            Assert.IsTrue(attr.value != IntPtr.Zero);
        ...
        public void _04_StringAttributeTest()
        {
            ...
            Assert.IsTrue(attr.type == NativeULongUtils.ConvertUInt32FromCKA(CKA.CKA_LABEL));
            Assert.IsTrue(attr.value != IntPtr.Zero);
            Assert.IsTrue(attr.valueLen == NativeULongUtils.ConvertUInt32FromInt32(originalValue.Length));
        ...
        public void _05_ByteArrayAttributeTest()
        {
            ...
            Assert.IsTrue(attr.type == NativeULongUtils.ConvertUInt32FromCKA(CKA.CKA_ID));
            Assert.IsTrue(attr.value != IntPtr.Zero);
            Assert.IsTrue(attr.valueLen == NativeULongUtils.ConvertUInt32FromInt32(originalValue.Length));
        ...
        public void _06_DateTimeAttributeTest()
        {
            ...
            Assert.IsTrue(attr.type == NativeULongUtils.ConvertUInt32FromCKA(CKA.CKA_START_DATE));
            Assert.IsTrue(attr.value != IntPtr.Zero);
        ...
        public void _07_AttributeArrayAttributeTest()
        {
            ...
            Assert.IsTrue(attr.type == NativeULongUtils.ConvertUInt32FromCKA(CKA.CKA_WRAP_TEMPLATE));
            Assert.IsTrue(attr.value != IntPtr.Zero);
            Assert.IsTrue(attr.valueLen == NativeULongUtils.ConvertUInt32FromInt32(UnmanagedMemory.SizeOf(typeof(CK_ATTRIBUTE)) * originalValue.Length));
        ...
        public void _08_UintArrayAttributeTest()
        {
            ...
            Assert.IsTrue(attr.type == NativeULongUtils.ConvertUInt32FromCKA(CKA.CKA_ALLOWED_MECHANISMS));
            Assert.IsTrue(attr.value != IntPtr.Zero);
            Assert.IsTrue(attr.valueLen == NativeULongUtils.ConvertUInt32FromInt32(UnmanagedMemory.SizeOf(typeof(NativeULong)) * originalValue.Length));
        ...
        public void _10_CustomAttributeTest()
        {
            ...
            Assert.IsTrue(attr.type == NativeULongUtils.ConvertUInt32FromCKA(CKA.CKA_VALUE));
            Assert.IsTrue(attr.value == IntPtr.Zero);
            Assert.IsTrue(attr.valueLen == 0);
            ...
            attr.valueLen = NativeULongUtils.ConvertUInt32FromInt32(originalValue.Length);
            Assert.IsTrue(attr.type == NativeULongUtils.ConvertUInt32FromCKA(CKA.CKA_VALUE));
            Assert.IsTrue(attr.value != IntPtr.Zero);
            Assert.IsTrue(attr.valueLen == NativeULongUtils.ConvertUInt32FromInt32(originalValue.Length));

            // Read the value of attribute
            byte[] recoveredValue = UnmanagedMemory.Read(attr.value, NativeULongUtils.ConvertUInt32ToInt32(attr.valueLen));
            Assert.IsTrue(ConvertUtils.BytesToBase64String(originalValue) == ConvertUtils.BytesToBase64String(recoveredValue));
