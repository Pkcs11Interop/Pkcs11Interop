...
namespace Net.Pkcs11Interop.Tests.LowLevelAPI81
{
    ...
    public class _15_MechanismTest
    {
        ...
        public void _01_EmptyParameterTest()
        {
            ...
            Assert.IsTrue(mechanism.Mechanism == NativeULongUtils.GetUInt64FromCKM(CKM.CKM_RSA_PKCS));
        ...
        public void _02_ByteArrayParameterTest()
        {
            ...
            Assert.IsTrue(mechanism.Mechanism == NativeULongUtils.GetUInt64FromCKM(CKM.CKM_AES_CBC));
            Assert.IsTrue(mechanism.Parameter != IntPtr.Zero);
            Assert.IsTrue(mechanism.ParameterLen == NativeULongUtils.GetUInt64FromInt32(parameter.Length));
        ...
        public void _03_StructureParameterTest()
        {
            ...
            parameter.Len = NativeULongUtils.GetUInt64FromInt32(data.Length);
            ...
            Assert.IsTrue(mechanism.Mechanism == NativeULongUtils.GetUInt64FromCKM(CKM.CKM_XOR_BASE_AND_DATA));
            Assert.IsTrue(mechanism.Parameter != IntPtr.Zero);
            Assert.IsTrue(mechanism.ParameterLen == NativeULongUtils.GetUInt64FromInt32(UnmanagedMemory.SizeOf(typeof(CK_KEY_DERIVATION_STRING_DATA))));
