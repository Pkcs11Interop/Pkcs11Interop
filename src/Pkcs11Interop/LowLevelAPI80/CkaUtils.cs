...
namespace Net.Pkcs11Interop.LowLevelAPI80
{
    ...
    public static class CkaUtils
    {
        ...
        {
            return CreateAttribute(ConvertUtils.UInt64FromCKA(type), value);
        }
        ...
        {
            return CreateAttribute(ConvertUtils.UInt64FromCKA(type), ConvertUtils.UInt64FromCKC(value));
        }
        ...
        {
            return CreateAttribute(ConvertUtils.UInt64FromCKA(type), ConvertUtils.UInt64FromCKK(value));
        }
        ...
        {
            return CreateAttribute(ConvertUtils.UInt64FromCKA(type), ConvertUtils.UInt64FromCKO(value));
        }
        ...
        {
            return _CreateAttribute(type, ConvertUtils.UInt64ToBytes(value));
        }
        ...
        public static CK_ATTRIBUTE CreateAttribute(NativeULong type, CK_ATTRIBUTE[] value)
        {
            ...
            if ((value != null) && (value.Length > 0))
            {
                ...
                attribute.valueLen = ConvertUtils.UInt64FromInt32(ckAttributeSize * value.Length);
            }
            else
            {
        ...
        public static CK_ATTRIBUTE CreateAttribute(NativeULong type, NativeULong[] value)
        {
            ...
            if ((value != null) && (value.Length > 0))
            {
                ...
                for (int i = 0; i < value.Length; i++)
                {
                    ...
                    UnmanagedMemory.Write(tempPointer, ConvertUtils.UInt64ToBytes(value[i]));
                }
                attribute.valueLen = ConvertUtils.UInt64FromInt32(ckmSize * value.Length);
            }
            else
            {
                attribute.value = IntPtr.Zero;
        ...
        public static CK_ATTRIBUTE CreateAttribute(CKA type, CKM[] value)
        {
            ...
            if (value != null)
            {
                ...
                for (int i = 0; i < value.Length; i++)
                    nativeULongArray[i] = ConvertUtils.UInt64FromCKM(value[i]);
            }
        ...
        public static void ConvertValue(ref CK_ATTRIBUTE attribute, out CKM[] value)
        {
            ...
            if (nativeULongArray != null)
            {
                ...
                for (int i = 0; i < nativeULongArray.Length; i++)
                    ckmArray[i] = ConvertUtils.UInt64ToCKM(nativeULongArray[i]);
            }
            value = ckmArray;
        }
        ...
        private static CK_ATTRIBUTE _CreateAttribute(NativeULong type, byte[] value)
        {
            ...
            if (value != null)
            {
                ...
                attribute.valueLen = ConvertUtils.UInt64FromInt32(value.Length);
            }
            else
            {
                attribute.value = IntPtr.Zero;
        ...
        private static byte[] ConvertValue(ref CK_ATTRIBUTE attribute)
        {
            ...
            if (attribute.value != IntPtr.Zero)
                value = UnmanagedMemory.Read(attribute.value, ConvertUtils.UInt64ToInt32(attribute.valueLen));
