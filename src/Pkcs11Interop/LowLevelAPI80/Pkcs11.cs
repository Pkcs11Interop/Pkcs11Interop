...
namespace Net.Pkcs11Interop.LowLevelAPI80
{
    ...
    public class Pkcs11 : IDisposable
    {
        ...
        public CKR C_GetUnmanagedStructSizeList(ulong[] sizeList, ref ulong count)
        {
            if (this._disposed)
                throw new ObjectDisposedException(this.GetType().FullName);
        ...
        /// <param name="count">Location that receives the number of sizes</param>
        /// <returns>CKR_ARGUMENTS_BAD, CKR_BUFFER_TOO_SMALL, CKR_OK</returns>
        public CKR C_GetManagedStructSizeList(ulong[] sizeList, ref ulong count)
        {
            int[] sizes = new int[] {
                UnmanagedMemory.SizeOf(typeof(CK_ATTRIBUTE)),
                UnmanagedMemory.SizeOf(typeof(CK_C_INITIALIZE_ARGS)),
                UnmanagedMemory.SizeOf(typeof(CK_FUNCTION_LIST)),
                UnmanagedMemory.SizeOf(typeof(CK_INFO)),
                UnmanagedMemory.SizeOf(typeof(CK_MECHANISM)),
                UnmanagedMemory.SizeOf(typeof(CK_MECHANISM_INFO)),
                UnmanagedMemory.SizeOf(typeof(CK_SESSION_INFO)),
                UnmanagedMemory.SizeOf(typeof(CK_SLOT_INFO)),
                UnmanagedMemory.SizeOf(typeof(CK_TOKEN_INFO)),
                UnmanagedMemory.SizeOf(typeof(CK_VERSION)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_AES_CBC_ENCRYPT_DATA_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_AES_CTR_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_ARIA_CBC_ENCRYPT_DATA_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_CAMELLIA_CBC_ENCRYPT_DATA_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_CAMELLIA_CTR_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_CMS_SIG_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_DES_CBC_ENCRYPT_DATA_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_ECDH1_DERIVE_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_ECDH2_DERIVE_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_ECMQV_DERIVE_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_EXTRACT_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_KEA_DERIVE_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_KEY_DERIVATION_STRING_DATA)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_KEY_WRAP_SET_OAEP_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_KIP_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_MAC_GENERAL_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_OTP_PARAM)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_OTP_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_OTP_SIGNATURE_INFO)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_PBE_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_PKCS5_PBKD2_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_RC2_CBC_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_RC2_MAC_GENERAL_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_RC2_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_RC5_CBC_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_RC5_MAC_GENERAL_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_RC5_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_RSA_PKCS_OAEP_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_RSA_PKCS_PSS_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_SKIPJACK_PRIVATE_WRAP_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_SKIPJACK_RELAYX_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_SSL3_KEY_MAT_OUT)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_SSL3_KEY_MAT_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_SSL3_MASTER_KEY_DERIVE_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_SSL3_RANDOM_DATA)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_TLS_PRF_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_WTLS_KEY_MAT_OUT)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_WTLS_KEY_MAT_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_WTLS_MASTER_KEY_DERIVE_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_WTLS_PRF_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_WTLS_RANDOM_DATA)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_X9_42_DH1_DERIVE_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_X9_42_DH2_DERIVE_PARAMS)),
                UnmanagedMemory.SizeOf(typeof(MechanismParams.CK_X9_42_MQV_DERIVE_PARAMS))
            };

            ulong sizes_count = Convert.ToUInt64(sizes.Length);
            ...
            {
                if (sizes_count > count)
                    return CKR.CKR_BUFFER_TOO_SMALL;

                for (int i = 0; i < sizes.Length; i++)
                    sizeList[i] = Convert.ToUInt64(sizes[i]);
