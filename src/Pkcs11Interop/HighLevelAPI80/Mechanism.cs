...
namespace Net.Pkcs11Interop.HighLevelAPI80
{
    ...
    public class Mechanism : IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI80.CK_MECHANISM _ckMechanism;

        /// <summary>
        /// Low level mechanism structure
        /// </summary>
        internal LowLevelAPI80.CK_MECHANISM CkMechanism
        {
            get
            {
                if (this._disposed)
        ...
        {
            _ckMechanism = LowLevelAPI80.CkmUtils.CreateMechanism(type);
        }
        ...
        {
            _ckMechanism = LowLevelAPI80.CkmUtils.CreateMechanism(type, parameter);
        }
        ...
        public Mechanism(ulong type, IMechanismParams parameter)
        {
            ...
            _ckMechanism = LowLevelAPI80.CkmUtils.CreateMechanism(type, lowLevelParams);
        }
