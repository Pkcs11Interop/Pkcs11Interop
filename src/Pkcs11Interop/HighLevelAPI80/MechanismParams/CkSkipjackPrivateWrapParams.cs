...
namespace Net.Pkcs11Interop.HighLevelAPI80.MechanismParams
{
    ...
    public class CkSkipjackPrivateWrapParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI80.MechanismParams.CK_SKIPJACK_PRIVATE_WRAP_PARAMS _lowLevelStruct = new LowLevelAPI80.MechanismParams.CK_SKIPJACK_PRIVATE_WRAP_PARAMS();
