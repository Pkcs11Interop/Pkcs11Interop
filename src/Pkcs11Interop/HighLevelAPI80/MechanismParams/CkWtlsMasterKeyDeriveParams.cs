...
namespace Net.Pkcs11Interop.HighLevelAPI80.MechanismParams
{
    ...
    public class CkWtlsMasterKeyDeriveParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI80.MechanismParams.CK_WTLS_MASTER_KEY_DERIVE_PARAMS _lowLevelStruct = new LowLevelAPI80.MechanismParams.CK_WTLS_MASTER_KEY_DERIVE_PARAMS();
