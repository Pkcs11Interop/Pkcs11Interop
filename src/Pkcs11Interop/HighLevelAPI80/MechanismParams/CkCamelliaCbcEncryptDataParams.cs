...
namespace Net.Pkcs11Interop.HighLevelAPI80.MechanismParams
{
    ...
    public class CkCamelliaCbcEncryptDataParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI80.MechanismParams.CK_CAMELLIA_CBC_ENCRYPT_DATA_PARAMS _lowLevelStruct = new LowLevelAPI80.MechanismParams.CK_CAMELLIA_CBC_ENCRYPT_DATA_PARAMS();
