...
namespace Net.Pkcs11Interop.HighLevelAPI80.MechanismParams
{
    ...
    public class CkAriaCbcEncryptDataParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI81.MechanismParams.CK_ARIA_CBC_ENCRYPT_DATA_PARAMS _lowLevelStruct = new LowLevelAPI81.MechanismParams.CK_ARIA_CBC_ENCRYPT_DATA_PARAMS();
