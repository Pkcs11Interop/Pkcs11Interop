...
namespace Net.Pkcs11Interop.HighLevelAPI80.MechanismParams
{
    ...
    public class CkX942Dh1DeriveParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI81.MechanismParams.CK_X9_42_DH1_DERIVE_PARAMS _lowLevelStruct = new LowLevelAPI81.MechanismParams.CK_X9_42_DH1_DERIVE_PARAMS();
        ...
        public CkX942Dh1DeriveParams(ulong kdf, byte[] otherInfo, byte[] publicData)
        {
            ...
            if (otherInfo != null)
            {
                _lowLevelStruct.OtherInfo = Common.UnmanagedMemory.Allocate(otherInfo.Length);
                Common.UnmanagedMemory.Write(_lowLevelStruct.OtherInfo, otherInfo);
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!this._disposed)
            {
                ...
                Common.UnmanagedMemory.Free(ref _lowLevelStruct.OtherInfo);
                _lowLevelStruct.OtherInfoLen = 0;
