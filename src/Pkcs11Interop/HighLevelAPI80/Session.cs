...
namespace Net.Pkcs11Interop.HighLevelAPI80
{
    ...
    public class Session : ISession
    {
        ...
        protected internal Session(Pkcs11InteropFactories factories, LowLevelAPI80.Pkcs11Library pkcs11Library, ulong sessionId)
        {
            ...
            _sessionId = ConvertUtils.UInt64FromUInt64(sessionId);
        }
        ...
        public void InitPin(string userPin)
        {
            ...
            if (userPin != null)
            {
                ...
                pinValueLen = ConvertUtils.UInt64FromInt32(pinValue.Length);
            }
        ...
        public void InitPin(byte[] userPin)
        {
            ...
            {
                pinValue = userPin;
                pinValueLen = ConvertUtils.UInt64FromInt32(userPin.Length);
            }
        ...
        public void SetPin(string oldPin, string newPin)
        {
            ...
            if (oldPin != null)
            {
                ...
                oldPinValueLen = ConvertUtils.UInt64FromInt32(oldPinValue.Length);
            }
            ...
            if (newPin != null)
            {
                ...
                newPinValueLen = ConvertUtils.UInt64FromInt32(newPinValue.Length);
            }
        ...
        public void SetPin(byte[] oldPin, byte[] newPin)
        {
            ...
            {
                oldPinValue = oldPin;
                oldPinValueLen = ConvertUtils.UInt64FromInt32(oldPin.Length);
            }
            ...
            {
                newPinValue = newPin;
                newPinValueLen = ConvertUtils.UInt64FromInt32(newPin.Length);
            }
        ...
        public void SetOperationState(byte[] state, IObjectHandle encryptionKey, IObjectHandle authenticationKey)
        {
            ...
            CKR rv = _pkcs11Library.C_SetOperationState(_sessionId, state, ConvertUtils.UInt64FromInt32(state.Length), ConvertUtils.UInt64FromUInt64(encryptionKey.ObjectId), ConvertUtils.UInt64FromUInt64(authenticationKey.ObjectId));
            if (rv != CKR.CKR_OK)
        ...
        public void Login(CKU userType, byte[] pin)
        {
            ...
            {
                pinValue = pin;
                pinValueLen = ConvertUtils.UInt64FromInt32(pin.Length);
            }
        ...
        public IObjectHandle CreateObject(List<IObjectAttribute> attributes)
        {
            ...
            if (attributes != null)
            {
                templateLength = ConvertUtils.UInt64FromInt32(attributes.Count);
                template = new CK_ATTRIBUTE[templateLength];
                for (int i = 0; i < ConvertUtils.UInt64ToInt32(templateLength); i++)
        ...
        public IObjectHandle CopyObject(IObjectHandle objectHandle, List<IObjectAttribute> attributes)
        {
            ...
            CKR rv = _pkcs11Library.C_CopyObject(_sessionId, ConvertUtils.UInt64FromUInt64(objectHandle.ObjectId), template, templateLength, ref objectId);
            if (rv != CKR.CKR_OK)
        ...
        public void DestroyObject(IObjectHandle objectHandle)
        {
            ...
            CKR rv = _pkcs11Library.C_DestroyObject(_sessionId, ConvertUtils.UInt64FromUInt64(objectHandle.ObjectId));
            if (rv != CKR.CKR_OK)
        ...
        public ulong GetObjectSize(IObjectHandle objectHandle)
        {
            ...
            CKR rv = _pkcs11Library.C_GetObjectSize(_sessionId, ConvertUtils.UInt64FromUInt64(objectHandle.ObjectId), ref objectSize);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_GetObjectSize", rv);

            return ConvertUtils.UInt64ToUInt64(objectSize);
        }
        ...
        public List<IObjectAttribute> GetAttributeValue(IObjectHandle objectHandle, List<CKA> attributes)
        {
            ...
            foreach (CKA attribute in attributes)
                ulongs.Add(ConvertUtils.UInt64FromCKA(attribute));
        ...
        public List<IObjectAttribute> GetAttributeValue(IObjectHandle objectHandle, List<ulong> attributes)
        {
            ...
            for (int i = 0; i < attributes.Count; i++)
                template[i] = CkaUtils.CreateAttribute(ConvertUtils.UInt64FromUInt64(attributes[i]));

            // Determine size of attribute values
            CKR rv = _pkcs11Library.C_GetAttributeValue(_sessionId, ConvertUtils.UInt64FromUInt64(objectHandle.ObjectId), template, ConvertUtils.UInt64FromInt32(template.Length));
            ...
            for (int i = 0; i < template.Length; i++)
            {
                ...
                if ((NativeLong)template[i].valueLen != -1)
                    template[i].value = Common.UnmanagedMemory.Allocate(ConvertUtils.UInt64ToInt32(template[i].valueLen));
            }
        ...
        public void SetAttributeValue(IObjectHandle objectHandle, List<IObjectAttribute> attributes)
        {
            ...
            CKR rv = _pkcs11Library.C_SetAttributeValue(_sessionId, ConvertUtils.UInt64FromUInt64(objectHandle.ObjectId), template, ConvertUtils.UInt64FromInt32(template.Length));
            if (rv != CKR.CKR_OK)
        ...
        public List<IObjectHandle> FindObjects(int objectCount)
        {
            ...
            CKR rv = _pkcs11Library.C_FindObjects(_sessionId, objects, ConvertUtils.UInt64FromInt32(objectCount), ref foundObjectsCount);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_FindObjects", rv);

            for (int i = 0; i < ConvertUtils.UInt64ToInt32(foundObjectsCount); i++)
        ...
        public List<IObjectHandle> FindAllObjects(List<IObjectAttribute> attributes)
        {
            ...
            while (objectCount == objectsLength)
            {
                ...
                for (int i = 0; i < ConvertUtils.UInt64ToInt32(objectCount); i++)
                    foundObjects.Add(new ObjectHandle(objects[i]));
            }
        ...
        public byte[] Encrypt(IMechanism mechanism, IObjectHandle keyHandle, byte[] data)
        {
            ...
            CKR rv = _pkcs11Library.C_EncryptInit(_sessionId, ref ckMechanism, ConvertUtils.UInt64FromUInt64(keyHandle.ObjectId));
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_EncryptInit", rv);

            NativeULong encryptedDataLen = 0;
            rv = _pkcs11Library.C_Encrypt(_sessionId, data, ConvertUtils.UInt64FromInt32(data.Length), null, ref encryptedDataLen);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_Encrypt", rv);

            byte[] encryptedData = new byte[encryptedDataLen];
            rv = _pkcs11Library.C_Encrypt(_sessionId, data, ConvertUtils.UInt64FromInt32(data.Length), encryptedData, ref encryptedDataLen);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_Encrypt", rv);

            if (encryptedData.Length != ConvertUtils.UInt64ToInt32(encryptedDataLen))
                Array.Resize(ref encryptedData, ConvertUtils.UInt64ToInt32(encryptedDataLen));
        ...
        public void Encrypt(IMechanism mechanism, IObjectHandle keyHandle, Stream inputStream, Stream outputStream, int bufferLength)
        {
            ...
            while ((bytesRead = inputStream.Read(part, 0, part.Length)) > 0)
            {
                ...
                rv = _pkcs11Library.C_EncryptUpdate(_sessionId, part, ConvertUtils.UInt64FromInt32(bytesRead), encryptedPart, ref encryptedPartLen);
                if (rv != CKR.CKR_OK)
        ...
        public byte[] Decrypt(IMechanism mechanism, IObjectHandle keyHandle, byte[] encryptedData)
        {
            ...
            CKR rv = _pkcs11Library.C_DecryptInit(_sessionId, ref ckMechanism, ConvertUtils.UInt64FromUInt64(keyHandle.ObjectId));
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_DecryptInit", rv);

            NativeULong decryptedDataLen = 0;
            rv = _pkcs11Library.C_Decrypt(_sessionId, encryptedData, ConvertUtils.UInt64FromInt32(encryptedData.Length), null, ref decryptedDataLen);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_Decrypt", rv);

            byte[] decryptedData = new byte[decryptedDataLen];
            rv = _pkcs11Library.C_Decrypt(_sessionId, encryptedData, ConvertUtils.UInt64FromInt32(encryptedData.Length), decryptedData, ref decryptedDataLen);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_Decrypt", rv);
        ...
        public void Decrypt(IMechanism mechanism, IObjectHandle keyHandle, Stream inputStream, Stream outputStream, int bufferLength)
        {
            ...
            while ((bytesRead = inputStream.Read(encryptedPart, 0, encryptedPart.Length)) > 0)
            {
                ...
                rv = _pkcs11Library.C_DecryptUpdate(_sessionId, encryptedPart, ConvertUtils.UInt64FromInt32(bytesRead), part, ref partLen);
                if (rv != CKR.CKR_OK)
        ...
        public byte[] DigestKey(IMechanism mechanism, IObjectHandle keyHandle)
        {
            ...
            rv = _pkcs11Library.C_DigestKey(_sessionId, ConvertUtils.UInt64FromUInt64(keyHandle.ObjectId));
            if (rv != CKR.CKR_OK)
            ...
            if (digest.Length != ConvertUtils.UInt64ToInt32(digestLen))
                Array.Resize(ref digest, ConvertUtils.UInt64ToInt32(digestLen));
        ...
        public byte[] Digest(IMechanism mechanism, byte[] data)
        {
            ...
            NativeULong digestLen = 0;
            rv = _pkcs11Library.C_Digest(_sessionId, data, ConvertUtils.UInt64FromInt32(data.Length), null, ref digestLen);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_Digest", rv);

            byte[] digest = new byte[digestLen];
            rv = _pkcs11Library.C_Digest(_sessionId, data, ConvertUtils.UInt64FromInt32(data.Length), digest, ref digestLen);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_Digest", rv);
        ...
        public byte[] Digest(IMechanism mechanism, Stream inputStream, int bufferLength)
        {
            ...
            while ((bytesRead = inputStream.Read(part, 0, part.Length)) > 0)
            {
                rv = _pkcs11Library.C_DigestUpdate(_sessionId, part, ConvertUtils.UInt64FromInt32(bytesRead));
                if (rv != CKR.CKR_OK)
        ...
        protected byte[] Sign(IMechanism mechanism, IObjectHandle keyHandle, byte[] data, bool performLogin, byte[] keyPin)
        {
            ...
            CKR rv = _pkcs11Library.C_SignInit(_sessionId, ref ckMechanism, ConvertUtils.UInt64FromUInt64(keyHandle.ObjectId));
            if (rv != CKR.CKR_OK)
            ...
            if (performLogin)
            {
                ...
                {
                    pinValue = keyPin;
                    pinValueLen = ConvertUtils.UInt64FromInt32(keyPin.Length);
                }
            ...
            rv = _pkcs11Library.C_Sign(_sessionId, data, ConvertUtils.UInt64FromInt32(data.Length), null, ref signatureLen);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_Sign", rv);

            byte[] signature = new byte[signatureLen];
            rv = _pkcs11Library.C_Sign(_sessionId, data, ConvertUtils.UInt64FromInt32(data.Length), signature, ref signatureLen);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_Sign", rv);
        ...
        protected byte[] Sign(IMechanism mechanism, IObjectHandle keyHandle, Stream inputStream, int bufferLength, bool performLogin, byte[] keyPin)
        {
            ...
            while ((bytesRead = inputStream.Read(part, 0, part.Length)) > 0)
            {
                rv = _pkcs11Library.C_SignUpdate(_sessionId, part, ConvertUtils.UInt64FromInt32(bytesRead));
                if (rv != CKR.CKR_OK)
        ...
        protected byte[] SignRecover(IMechanism mechanism, IObjectHandle keyHandle, byte[] data, bool performLogin, byte[] keyPin)
        {
            ...
            CKR rv = _pkcs11Library.C_SignRecoverInit(_sessionId, ref ckMechanism, ConvertUtils.UInt64FromUInt64(keyHandle.ObjectId));
            if (rv != CKR.CKR_OK)
            ...
            NativeULong signatureLen = 0;
            rv = _pkcs11Library.C_SignRecover(_sessionId, data, ConvertUtils.UInt64FromInt32(data.Length), null, ref signatureLen);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_SignRecover", rv);

            byte[] signature = new byte[signatureLen];
            rv = _pkcs11Library.C_SignRecover(_sessionId, data, ConvertUtils.UInt64FromInt32(data.Length), signature, ref signatureLen);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_SignRecover", rv);
        ...
        public void Verify(IMechanism mechanism, IObjectHandle keyHandle, byte[] data, byte[] signature, out bool isValid)
        {
            ...
            CKR rv = _pkcs11Library.C_VerifyInit(_sessionId, ref ckMechanism, ConvertUtils.UInt64FromUInt64(keyHandle.ObjectId));
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_VerifyInit", rv);

            rv = _pkcs11Library.C_Verify(_sessionId, data, ConvertUtils.UInt64FromInt32(data.Length), signature, ConvertUtils.UInt64FromInt32(signature.Length));
            if (rv == CKR.CKR_OK)
                isValid = true;
        ...
        public void Verify(IMechanism mechanism, IObjectHandle keyHandle, Stream inputStream, byte[] signature, out bool isValid, int bufferLength)
        {
            ...
            while ((bytesRead = inputStream.Read(part, 0, part.Length)) > 0)
            {
                rv = _pkcs11Library.C_VerifyUpdate(_sessionId, part, ConvertUtils.UInt64FromInt32(bytesRead));
                if (rv != CKR.CKR_OK)
                    throw new Pkcs11Exception("C_VerifyUpdate", rv);
            }

            rv = _pkcs11Library.C_VerifyFinal(_sessionId, signature, ConvertUtils.UInt64FromInt32(signature.Length));
            if (rv == CKR.CKR_OK)
                isValid = true;
            else if (rv == CKR.CKR_SIGNATURE_INVALID)
                isValid = false;
        ...
        public byte[] VerifyRecover(IMechanism mechanism, IObjectHandle keyHandle, byte[] signature, out bool isValid)
        {
            ...
            CKR rv = _pkcs11Library.C_VerifyRecoverInit(_sessionId, ref ckMechanism, ConvertUtils.UInt64FromUInt64(keyHandle.ObjectId));
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_VerifyRecoverInit", rv);

            NativeULong dataLen = 0;
            rv = _pkcs11Library.C_VerifyRecover(_sessionId, signature, ConvertUtils.UInt64FromInt32(signature.Length), null, ref dataLen);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_VerifyRecover", rv);

            byte[] data = new byte[dataLen];
            rv = _pkcs11Library.C_VerifyRecover(_sessionId, signature, ConvertUtils.UInt64FromInt32(signature.Length), data, ref dataLen);
            if (rv == CKR.CKR_OK)
                isValid = true;
            else if (rv == CKR.CKR_SIGNATURE_INVALID)
                isValid = false;
            ...
            if (data.Length != ConvertUtils.UInt64ToInt32(dataLen))
                Array.Resize(ref data, ConvertUtils.UInt64ToInt32(dataLen));
        ...
        public byte[] DigestEncrypt(IMechanism digestingMechanism, IMechanism encryptionMechanism, IObjectHandle keyHandle, Stream inputStream, Stream outputStream, int bufferLength)
        {
            ...
            rv = _pkcs11Library.C_EncryptInit(_sessionId, ref ckEncryptionMechanism, ConvertUtils.UInt64FromUInt64(keyHandle.ObjectId));
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_EncryptInit", rv);
            ...
            {
                encryptedPartLen = ConvertUtils.UInt64FromInt32(encryptedPart.Length);
                rv = _pkcs11Library.C_DigestEncryptUpdate(_sessionId, part, ConvertUtils.UInt64FromInt32(bytesRead), encryptedPart, ref encryptedPartLen);
                if (rv != CKR.CKR_OK)
        ...
        public byte[] DecryptDigest(IMechanism digestingMechanism, IMechanism decryptionMechanism, IObjectHandle keyHandle, Stream inputStream, Stream outputStream, int bufferLength)
        {
            ...
            rv = _pkcs11Library.C_DecryptInit(_sessionId, ref ckDecryptionMechanism, ConvertUtils.UInt64FromUInt64(keyHandle.ObjectId));
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_DecryptInit", rv);
            ...
            {
                partLen = ConvertUtils.UInt64FromInt32(part.Length);
                rv = _pkcs11Library.C_DecryptDigestUpdate(_sessionId, encryptedPart, ConvertUtils.UInt64FromInt32(bytesRead), part, ref partLen);
                if (rv != CKR.CKR_OK)
        ...
        protected byte[] SignEncrypt(IMechanism signingMechanism, IObjectHandle signingKeyHandle, IMechanism encryptionMechanism, IObjectHandle encryptionKeyHandle, Stream inputStream, Stream outputStream, int bufferLength, bool performLogin, byte[] signingKeyPin)
        {
            ...
            CKR rv = _pkcs11Library.C_SignInit(_sessionId, ref ckSigningMechanism, ConvertUtils.UInt64FromUInt64(signingKeyHandle.ObjectId));
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_SignInit", rv);
            ...
            if (performLogin)
            {
                ...
                if (signingKeyPin != null)
                {
                    ...
                    pinValueLen = ConvertUtils.UInt64FromInt32(signingKeyPin.Length);
                }
            ...
            rv = _pkcs11Library.C_EncryptInit(_sessionId, ref ckEncryptionMechanism, ConvertUtils.UInt64FromUInt64(encryptionKeyHandle.ObjectId));
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_EncryptInit", rv);
            ...
            {
                encryptedPartLen = ConvertUtils.UInt64FromInt32(encryptedPart.Length);
                rv = _pkcs11Library.C_SignEncryptUpdate(_sessionId, part, ConvertUtils.UInt64FromInt32(bytesRead), encryptedPart, ref encryptedPartLen);
                if (rv != CKR.CKR_OK)
        ...
        public void DecryptVerify(IMechanism verificationMechanism, IObjectHandle verificationKeyHandle, IMechanism decryptionMechanism, IObjectHandle decryptionKeyHandle, Stream inputStream, Stream outputStream, byte[] signature, out bool isValid, int bufferLength)
        {
            ...
            CKR rv = _pkcs11Library.C_VerifyInit(_sessionId, ref ckVerificationMechanism, ConvertUtils.UInt64FromUInt64(verificationKeyHandle.ObjectId));
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_VerifyInit", rv);

            CK_MECHANISM ckDecryptionMechanism = (CK_MECHANISM)decryptionMechanism.ToMarshalableStructure();

            rv = _pkcs11Library.C_DecryptInit(_sessionId, ref ckDecryptionMechanism, ConvertUtils.UInt64FromUInt64(decryptionKeyHandle.ObjectId));
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_DecryptInit", rv);
            ...
            {
                partLen = ConvertUtils.UInt64FromInt32(part.Length);
                rv = _pkcs11Library.C_DecryptVerifyUpdate(_sessionId, encryptedPart, ConvertUtils.UInt64FromInt32(bytesRead), part, ref partLen);
                if (rv != CKR.CKR_OK)
        ...
        public void GenerateKeyPair(IMechanism mechanism, List<IObjectAttribute> publicKeyAttributes, List<IObjectAttribute> privateKeyAttributes, out IObjectHandle publicKeyHandle, out IObjectHandle privateKeyHandle)
        {
            ...
            {
                publicKeyTemplateLength = ConvertUtils.UInt64FromInt32(publicKeyAttributes.Count);
                publicKeyTemplate = new CK_ATTRIBUTE[publicKeyTemplateLength];
                for (int i = 0; i < ConvertUtils.UInt64ToInt32(publicKeyTemplateLength); i++)
            ...
            {
                privateKeyTemplateLength = ConvertUtils.UInt64FromInt32(privateKeyAttributes.Count);
                privateKeyTemplate = new CK_ATTRIBUTE[privateKeyTemplateLength];
                for (int i = 0; i < ConvertUtils.UInt64ToInt32(privateKeyTemplateLength); i++)
        ...
        public byte[] WrapKey(IMechanism mechanism, IObjectHandle wrappingKeyHandle, IObjectHandle keyHandle)
        {
            ...
            CKR rv = _pkcs11Library.C_WrapKey(_sessionId, ref ckMechanism, ConvertUtils.UInt64FromUInt64(wrappingKeyHandle.ObjectId), ConvertUtils.UInt64FromUInt64(keyHandle.ObjectId), null, ref wrappedKeyLen);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_WrapKey", rv);

            byte[] wrappedKey = new byte[wrappedKeyLen];
            rv = _pkcs11Library.C_WrapKey(_sessionId, ref ckMechanism, ConvertUtils.UInt64FromUInt64(wrappingKeyHandle.ObjectId), ConvertUtils.UInt64FromUInt64(keyHandle.ObjectId), wrappedKey, ref wrappedKeyLen);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_WrapKey", rv);

            if (wrappedKey.Length != ConvertUtils.UInt64ToInt32(wrappedKeyLen))
                Array.Resize(ref wrappedKey, ConvertUtils.UInt64ToInt32(wrappedKeyLen));
        ...
        public IObjectHandle UnwrapKey(IMechanism mechanism, IObjectHandle unwrappingKeyHandle, byte[] wrappedKey, List<IObjectAttribute> attributes)
        {
            ...
            if (attributes != null)
            {
                ...
                for (int i = 0; i < attributes.Count; i++)
                    template[i] = (CK_ATTRIBUTE)attributes[i].ToMarshalableStructure();
                templateLen = ConvertUtils.UInt64FromInt32(attributes.Count);
            }

            NativeULong unwrappedKey = CK.CK_INVALID_HANDLE;
            CKR rv = _pkcs11Library.C_UnwrapKey(_sessionId, ref ckMechanism, ConvertUtils.UInt64FromUInt64(unwrappingKeyHandle.ObjectId), wrappedKey, ConvertUtils.UInt64FromInt32(wrappedKey.Length), template, templateLen, ref unwrappedKey);
            if (rv != CKR.CKR_OK)
        ...
        public IObjectHandle DeriveKey(IMechanism mechanism, IObjectHandle baseKeyHandle, List<IObjectAttribute> attributes)
        {
            ...
            CKR rv = _pkcs11Library.C_DeriveKey(_sessionId, ref ckMechanism, ConvertUtils.UInt64FromUInt64(baseKeyHandle.ObjectId), template, templateLen, ref derivedKey);
            if (rv != CKR.CKR_OK)
        ...
        public void SeedRandom(byte[] seed)
        {
            ...
            CKR rv = _pkcs11Library.C_SeedRandom(_sessionId, seed, ConvertUtils.UInt64FromInt32(seed.Length));
            if (rv != CKR.CKR_OK)
        ...
        public byte[] GenerateRandom(int length)
        {
            ...
            CKR rv = _pkcs11Library.C_GenerateRandom(_sessionId, randomData, ConvertUtils.UInt64FromInt32(length));
            if (rv != CKR.CKR_OK)
