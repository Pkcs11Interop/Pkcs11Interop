...
namespace Net.Pkcs11Interop.HighLevelAPI41.Factories
{
    ...
    public class MechanismParamsFactory : IMechanismParamsFactory
    {
        ...
        {
            return new CkAesCtrParams(ConvertUtils.UInt32FromUInt64(counterBits), cb);
        }
        ...
        {
            return new CkCamelliaCtrParams(ConvertUtils.UInt32FromUInt64(counterBits), cb);
        }
        ...
        {
            return new CkCcmParams(ConvertUtils.UInt32FromUInt64(dataLen), nonce, aad, ConvertUtils.UInt32FromUInt64(macLen));
        }
        ...
        {
            return new CkCmsSigParams(certificateHandle, ConvertUtils.UInt32FromUInt64(signingMechanism), ConvertUtils.UInt32FromUInt64(digestMechanism), contentType, requestedAttributes, requiredAttributes);
        }
        ...
        {
            return new CkDsaParameterGenParam(ConvertUtils.UInt32FromUInt64(hash), seed, ConvertUtils.UInt32FromUInt64(index));
        }
        ...
        {
            return new CkEcdh1DeriveParams(ConvertUtils.UInt32FromUInt64(kdf), sharedData, publicData);
        }
        ...
        {
            return new CkEcdh2DeriveParams(ConvertUtils.UInt32FromUInt64(kdf), sharedData, publicData, ConvertUtils.UInt32FromUInt64(privateDataLen), privateData, publicData2);
        }
        ...
        {
            return new CkEcdhAesKeyWrapParams(ConvertUtils.UInt32FromUInt64(aesKeyBits), ConvertUtils.UInt32FromUInt64(kdf), sharedData);
        }
        ...
        {
            return new CkEcmqvDeriveParams(ConvertUtils.UInt32FromUInt64(kdf), sharedData, publicData, ConvertUtils.UInt32FromUInt64(privateDataLen), privateData, publicData2, publicKey);
        }
        ...
        {
            return new CkExtractParams(ConvertUtils.UInt32FromUInt64(bit));
        }
        ...
        {
            return new CkGcmParams(iv, ConvertUtils.UInt32FromUInt64(ivBits), aad, ConvertUtils.UInt32FromUInt64(tagBits));
        }
        ...
        {
            return new CkGostR3410DeriveParams(ConvertUtils.UInt32FromUInt64(kdf), publicData, ukm);
        }
        ...
        {
            return new CkGostR3410KeyWrapParams(wrapOID, ukm, ConvertUtils.UInt32FromUInt64(key));
        }
        ...
        {
            return new CkKipParams(ConvertUtils.UInt32FromUInt64(mechanism), key, seed);
        }
        ...
        {
            return new CkMacGeneralParams(ConvertUtils.UInt32FromUInt64(macLength));
        }
        ...
        {
            return new CkOtpParam(ConvertUtils.UInt32FromUInt64(type), value);
        }
        ...
        {
            return new CkPbeParams(initVector, password, salt, ConvertUtils.UInt32FromUInt64(iteration));
        }
        ...
        {
            return new CkPkcs5Pbkd2Params(ConvertUtils.UInt32FromUInt64(saltSource), saltSourceData, ConvertUtils.UInt32FromUInt64(iterations), ConvertUtils.UInt32FromUInt64(prf), prfData, password);
        }
        ...
        {
            return new CkPkcs5Pbkd2Params2(ConvertUtils.UInt32FromUInt64(saltSource), saltSourceData, ConvertUtils.UInt32FromUInt64(iterations), ConvertUtils.UInt32FromUInt64(prf), prfData, password);
        }
        ...
        {
            return new CkRc2CbcParams(ConvertUtils.UInt32FromUInt64(effectiveBits), iv);
        }
        ...
        {
            return new CkRc2MacGeneralParams(ConvertUtils.UInt32FromUInt64(effectiveBits), ConvertUtils.UInt32FromUInt64(macLength));
        }
        ...
        {
            return new CkRc2Params(ConvertUtils.UInt32FromUInt64(effectiveBits));
        }
        ...
        {
            return new CkRc5CbcParams(ConvertUtils.UInt32FromUInt64(wordsize), ConvertUtils.UInt32FromUInt64(rounds), iv);
        }
        ...
        {
            return new CkRc5MacGeneralParams(ConvertUtils.UInt32FromUInt64(wordsize), ConvertUtils.UInt32FromUInt64(rounds), ConvertUtils.UInt32FromUInt64(macLength));
        }
        ...
        {
            return new CkRc5Params(ConvertUtils.UInt32FromUInt64(wordsize), ConvertUtils.UInt32FromUInt64(rounds));
        }
        ...
        {
            return new CkRsaPkcsOaepParams(ConvertUtils.UInt32FromUInt64(hashAlg), ConvertUtils.UInt32FromUInt64(mgf), ConvertUtils.UInt32FromUInt64(source), sourceData);
        }
        ...
        {
            return new CkRsaPkcsPssParams(ConvertUtils.UInt32FromUInt64(hashAlg), ConvertUtils.UInt32FromUInt64(mgf), ConvertUtils.UInt32FromUInt64(len));
        }
        ...
        {
            return new CkTlsMacParams(ConvertUtils.UInt32FromUInt64(prfHashMechanism), ConvertUtils.UInt32FromUInt64(macLength), ConvertUtils.UInt32FromUInt64(serverOrClient));
        }
        ...
        {
            return new CkTlsPrfParams(seed, label, ConvertUtils.UInt32FromUInt64(outputLen));
        }
        ...
        {
            return new CkWtlsPrfParams(ConvertUtils.UInt32FromUInt64(digestMechanism), seed, label, ConvertUtils.UInt32FromUInt64(outputLen));
        }
        ...
        {
            return new CkX942Dh1DeriveParams(ConvertUtils.UInt32FromUInt64(kdf), otherInfo, publicData);
        }
        ...
        {
            return new CkX942Dh2DeriveParams(ConvertUtils.UInt32FromUInt64(kdf), otherInfo, publicData, ConvertUtils.UInt32FromUInt64(privateDataLen), privateData, publicData2);
        }
