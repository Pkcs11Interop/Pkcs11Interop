...
namespace Net.Pkcs11Interop.HighLevelAPI41.MechanismParams
{
    ...
    public class CkAriaCbcEncryptDataParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private LowLevelAPI41.MechanismParams.CK_ARIA_CBC_ENCRYPT_DATA_PARAMS _lowLevelStruct = new LowLevelAPI41.MechanismParams.CK_ARIA_CBC_ENCRYPT_DATA_PARAMS();
