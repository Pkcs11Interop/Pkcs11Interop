...
namespace Net.Pkcs11Interop.HighLevelAPI41.MechanismParams
{
    ...
    public class CkCmsSigParams : ICkCmsSigParams
    {
        ...
        public CkCmsSigParams(IObjectHandle certificateHandle, NativeULong? signingMechanism, NativeULong? digestMechanism, string contentType, byte[] requestedAttributes, byte[] requiredAttributes)
        {
            ...
            _lowLevelStruct.CertificateHandle = ConvertUtils.UInt32FromUInt64(certificateHandle.ObjectId);

            if (signingMechanism != null)
            {
                byte[] bytes = ConvertUtils.UInt32ToBytes(signingMechanism.Value);
            ...
            {
                byte[] bytes = ConvertUtils.UInt32ToBytes(digestMechanism.Value);
            ...
            if (requestedAttributes != null)
            {
                ...
                _lowLevelStruct.RequestedAttributesLen = ConvertUtils.UInt32FromInt32(requestedAttributes.Length);
            }
            ...
            if (requiredAttributes != null)
            {
                ...
                _lowLevelStruct.RequiredAttributesLen = ConvertUtils.UInt32FromInt32(requiredAttributes.Length);
            }
        }
