...
namespace Net.Pkcs11Interop.LowLevelAPI8
{
    ...
    public class Pkcs11 : IDisposable
    {
        ...
        public CKR C_GetMechanismList(ulong slotId, CKM[] mechanismList, ref ulong count)
        {
            ...
            CKR rv = cGetMechanismList(slotId, ulongList, ref count);
        ...
        public CKR C_GetMechanismInfo(ulong slotId, CKM type, ref CK_MECHANISM_INFO info)
        {
            ...
            return cGetMechanismInfo(slotId, Convert.ToUInt64(type), ref info);
        }
        ...
        public CKR C_Login(ulong session, CKU userType, byte[] pin, ulong pinLen)
        {
            ...
            return cLogin(session, Convert.ToUInt64(userType), pin, pinLen);
        }
