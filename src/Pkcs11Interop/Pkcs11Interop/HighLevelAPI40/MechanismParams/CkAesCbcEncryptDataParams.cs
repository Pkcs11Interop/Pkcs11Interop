...
namespace Net.Pkcs11Interop.HighLevelAPI40.MechanismParams
{
    ...
    /// </summary>
    public class CkAesCbcEncryptDataParams : ICkAesCbcEncryptDataParams
    {
        /// <summary>
        ...
        /// </summary>
        private CK_AES_CBC_ENCRYPT_DATA_PARAMS _lowLevelStruct = new CK_AES_CBC_ENCRYPT_DATA_PARAMS();
        ...
        public CkAesCbcEncryptDataParams(byte[] iv, byte[] data)
        {
            ...
            if (data != null)
            {
                ...
                _lowLevelStruct.Length = NativeULongUtils.ConvertUInt32FromInt32(data.Length);
            }
        }
