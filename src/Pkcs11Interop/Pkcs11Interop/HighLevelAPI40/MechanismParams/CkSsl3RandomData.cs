    ...
    public class CkSsl3RandomData : ICkSsl3RandomData
    {
        ...
        public CkSsl3RandomData(byte[] clientRandom, byte[] serverRandom)
        {
            ...
            if (clientRandom != null)
            {
                ...
                _lowLevelStruct.ClientRandomLen = NativeULongUtils.ConvertUInt32FromInt32(clientRandom.Length);
            }
            ...
            if (serverRandom != null)
            {
                ...
                _lowLevelStruct.ServerRandomLen = NativeULongUtils.ConvertUInt32FromInt32(serverRandom.Length);
            }
        }
