        ...
        public MechanismFactory()
        {
            if (Platform.UnmanagedLongSize == 4)
            {
                if (Platform.StructPackingSize == 0)
                    _factory = new HighLevelAPI40.MechanismFactory();
                else
                    _factory = new HighLevelAPI41.MechanismFactory();
            }
            else
            {
                if (Platform.StructPackingSize == 0)
                    _factory = new HighLevelAPI80.MechanismFactory();
                else
                    _factory = new HighLevelAPI81.MechanismFactory();
            }
        }
