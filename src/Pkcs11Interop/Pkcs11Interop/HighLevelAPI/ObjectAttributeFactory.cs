...
namespace Net.Pkcs11Interop.HighLevelAPI
{
    ...
    public class ObjectAttributeFactory : IObjectAttributeFactory
    {
        ...
        public ObjectAttributeFactory()
        {
            if (Platform.UnmanagedLongSize == 4)
            {
                if (Platform.StructPackingSize == 0)
                    _factory = new HighLevelAPI40.ObjectAttributeFactory();
                else
                    _factory = new HighLevelAPI41.ObjectAttributeFactory();
            }
            else
            {
                if (Platform.StructPackingSize == 0)
                    _factory = new HighLevelAPI80.ObjectAttributeFactory();
                else
                    _factory = new HighLevelAPI81.ObjectAttributeFactory();
            }
        }
        ...
        {
            return _factory.CreateObjectAttribute(type);
        }
        ...
        {
            return _factory.CreateObjectAttribute(type, value);
        }
