...
namespace Net.Pkcs11Interop.HighLevelAPI.MechanismParams
{
    ...
    public class CkGostR3410DeriveParams : IMechanismParams, IDisposable
    {
        ...
        /// </summary>
        private HighLevelAPI40.MechanismParams.CkGostR3410DeriveParams _params40 = null;
        ...
        /// Platform specific CkGostR3410DeriveParams
        /// </summary>
        private HighLevelAPI80.MechanismParams.CkGostR3410DeriveParams _params80 = null;
        ...
        public CkGostR3410DeriveParams(ulong kdf, byte[] publicData, byte[] ukm)
        {
            if (Platform.UnmanagedLongSize == 4)
            {
                if (Platform.StructPackingSize == 0)
                    _params40 = new HighLevelAPI40.MechanismParams.CkGostR3410DeriveParams(Convert.ToUInt32(kdf), publicData, ukm);
                else
                    _params41 = new HighLevelAPI41.MechanismParams.CkGostR3410DeriveParams(Convert.ToUInt32(kdf), publicData, ukm);
            }
            else
            {
                if (Platform.StructPackingSize == 0)
