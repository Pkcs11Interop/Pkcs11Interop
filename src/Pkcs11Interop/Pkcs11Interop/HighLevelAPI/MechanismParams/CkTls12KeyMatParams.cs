...
namespace Net.Pkcs11Interop.HighLevelAPI.MechanismParams
{
    ...
    /// </summary>
    public class CkTls12KeyMatParams : IMechanismParams, IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        private HighLevelAPI40.MechanismParams.CkTls12KeyMatParams _params40 = null;

        /// <summary>
        /// Platform specific CkTls12KeyMatParams
        /// </summary>
        private HighLevelAPI41.MechanismParams.CkTls12KeyMatParams _params41 = null;

        /// <summary>
        /// Platform specific CkTls12KeyMatParams
        /// </summary>
        private HighLevelAPI80.MechanismParams.CkTls12KeyMatParams _params80 = null;

        /// <summary>
        /// Platform specific CkTls12KeyMatParams
        /// </summary>
        private HighLevelAPI81.MechanismParams.CkTls12KeyMatParams _params81 = null;
        ...
        public CkTls12KeyMatParams(ulong macSizeInBits, ulong keySizeInBits, ulong ivSizeInBits, bool isExport, CkSsl3RandomData randomInfo, ulong prfHashMechanism)
        {
            if (randomInfo == null)
            ...
            if (Platform.UnmanagedLongSize == 4)
            {
                if (Platform.StructPackingSize == 0)
                    _params40 = new HighLevelAPI40.MechanismParams.CkTls12KeyMatParams(Convert.ToUInt32(macSizeInBits), Convert.ToUInt32(keySizeInBits), Convert.ToUInt32(ivSizeInBits), isExport, _randomInfo._params40, Convert.ToUInt32(prfHashMechanism));
                else
                    _params41 = new HighLevelAPI41.MechanismParams.CkTls12KeyMatParams(Convert.ToUInt32(macSizeInBits), Convert.ToUInt32(keySizeInBits), Convert.ToUInt32(ivSizeInBits), isExport, _randomInfo._params41, Convert.ToUInt32(prfHashMechanism));
            }
            else
            {
                if (Platform.StructPackingSize == 0)
                    _params80 = new HighLevelAPI80.MechanismParams.CkTls12KeyMatParams(macSizeInBits, keySizeInBits, ivSizeInBits, isExport, _randomInfo._params80, prfHashMechanism);
                else
                    _params81 = new HighLevelAPI81.MechanismParams.CkTls12KeyMatParams(macSizeInBits, keySizeInBits, ivSizeInBits, isExport, _randomInfo._params81, prfHashMechanism);
            }
        }
