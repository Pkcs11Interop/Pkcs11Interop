    ...
    public class Pkcs11 : IPkcs11
    {
        ...
        public List<ISlot> GetSlotList(SlotsType slotsType)
        {
            ...
            else
            {
                ...
                if (slotList.Length != NativeULongUtils.ConvertUInt64ToInt32(slotCount))
                    Array.Resize(ref slotList, NativeULongUtils.ConvertUInt64ToInt32(slotCount));
        ...
        public void WaitForSlotEvent(WaitType waitType, out bool eventOccured, out ulong slotId)
        {
            ...
            if (waitType == WaitType.NonBlocking)
            {
                ...
                {
                    eventOccured = true;
                    slotId = NativeULongUtils.ConvertUInt64ToUInt64(slotId_);
                }
