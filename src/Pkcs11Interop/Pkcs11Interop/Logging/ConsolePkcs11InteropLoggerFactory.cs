...
{
    /// <summary>
    /// Factory for creation of loggers that log everything to console
    /// </summary>
    public class ConsolePkcs11InteropLoggerFactory : IPkcs11InteropLoggerFactory
    {
        /// <summary>
        ...
        {
            return new ConsolePkcs11InteropLogger(type);
        }
    }
}
