...
namespace Net.Pkcs11Interop.HighLevelAPI81.MechanismParams
{
    ...
    public class CkOtpSignatureInfo : ICkOtpSignatureInfo
    {
        ...
        public CkOtpSignatureInfo(byte[] signature)
        {
            ...
            for (int i = 0; i < NativeULongUtils.ConvertUInt64ToInt32(_lowLevelStruct.Count); i++)
            {
                ...
                byte[] ckOtpParamValue = UnmanagedMemory.Read(ckOtpParam.Value, NativeULongUtils.ConvertUInt64ToInt32(ckOtpParam.ValueLen));
