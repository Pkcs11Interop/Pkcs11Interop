    ...
    public class CkSkipjackRelayxParams : ICkSkipjackRelayxParams
    {
        ...
        public CkSkipjackRelayxParams(byte[] oldWrappedX, byte[] oldPassword, byte[] oldPublicData, byte[] oldRandomA, byte[] newPassword, byte[] newPublicData, byte[] newRandomA)
        {
            ...
            if (oldWrappedX != null)
            {
                ...
                _lowLevelStruct.OldWrappedXLen = NativeULongUtils.ConvertUInt64FromInt32(oldWrappedX.Length);
            }
            ...
            if (oldPassword != null)
            {
                ...
                _lowLevelStruct.OldPasswordLen = NativeULongUtils.ConvertUInt64FromInt32(oldPassword.Length);
            }
            ...
            if (oldPublicData != null)
            {
                ...
                _lowLevelStruct.OldPublicDataLen = NativeULongUtils.ConvertUInt64FromInt32(oldPublicData.Length);
            }
            ...
            if (oldRandomA != null)
            {
                ...
                _lowLevelStruct.OldRandomLen = NativeULongUtils.ConvertUInt64FromInt32(oldRandomA.Length);
            }
            ...
            if (newPassword != null)
            {
                ...
                _lowLevelStruct.NewPasswordLen = NativeULongUtils.ConvertUInt64FromInt32(newPassword.Length);
            }
            ...
            if (newPublicData != null)
            {
                ...
                _lowLevelStruct.NewPublicDataLen = NativeULongUtils.ConvertUInt64FromInt32(newPublicData.Length);
            }
            ...
            if (newRandomA != null)
            {
                ...
                _lowLevelStruct.NewRandomLen = NativeULongUtils.ConvertUInt64FromInt32(newRandomA.Length);
            }
        }
