    ...
    public class CkSsl3RandomData : ICkSsl3RandomData
    {
        ...
        public CkSsl3RandomData(byte[] clientRandom, byte[] serverRandom)
        {
            ...
            if (clientRandom != null)
            {
                ...
                _lowLevelStruct.ClientRandomLen = NativeULongUtils.GetUInt64FromInt32(clientRandom.Length);
            }
            ...
            if (serverRandom != null)
            {
                ...
                _lowLevelStruct.ServerRandomLen = NativeULongUtils.GetUInt64FromInt32(serverRandom.Length);
            }
        }
