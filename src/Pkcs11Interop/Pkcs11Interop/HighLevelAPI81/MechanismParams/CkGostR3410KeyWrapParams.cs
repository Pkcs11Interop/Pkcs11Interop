    ...
    public class CkGostR3410KeyWrapParams : ICkGostR3410KeyWrapParams
    {
        ...
        public CkGostR3410KeyWrapParams(byte[] wrapOID, byte[] ukm, NativeULong key)
        {
            ...
            if (wrapOID != null)
            {
                ...
                _lowLevelStruct.WrapOIDLen = NativeULongUtils.ConvertUInt64FromInt32(wrapOID.Length);
            }
            ...
            if (ukm != null)
            {
                ...
                _lowLevelStruct.UKMLen = NativeULongUtils.ConvertUInt64FromInt32(ukm.Length);
            }
