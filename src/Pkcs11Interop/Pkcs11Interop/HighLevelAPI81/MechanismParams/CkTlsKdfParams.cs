    ...
    public class CkTlsKdfParams : ICkTlsKdfParams
    {
        ...
        public CkTlsKdfParams(NativeULong prfMechanism, byte[] label, ICkSsl3RandomData randomInfo, byte[] contextData)
        {
            ...
            if (label != null)
            {
                ...
                _lowLevelStruct.LabelLength = NativeULongUtils.GetUInt64FromInt32(label.Length);
            }
            ...
            if (contextData != null)
            {
                ...
                _lowLevelStruct.ContextDataLength = NativeULongUtils.GetUInt64FromInt32(contextData.Length);
            }
        }
