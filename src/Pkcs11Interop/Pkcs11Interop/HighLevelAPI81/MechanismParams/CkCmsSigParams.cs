...
namespace Net.Pkcs11Interop.HighLevelAPI81.MechanismParams
{
    ...
    public class CkCmsSigParams : ICkCmsSigParams
    {
        ...
        public CkCmsSigParams(IObjectHandle certificateHandle, NativeULong? signingMechanism, NativeULong? digestMechanism, string contentType, byte[] requestedAttributes, byte[] requiredAttributes)
        {
            ...
            _lowLevelStruct.CertificateHandle = NativeULongUtils.ConvertUInt64FromUInt64(certificateHandle.ObjectId);

            if (signingMechanism != null)
            {
                byte[] bytes = NativeULongUtils.ConvertUInt64ToByteArray(signingMechanism.Value);
            ...
            {
                byte[] bytes = NativeULongUtils.ConvertUInt64ToByteArray(digestMechanism.Value);
            ...
            if (requestedAttributes != null)
            {
                ...
                _lowLevelStruct.RequestedAttributesLen = NativeULongUtils.ConvertUInt64FromInt32(requestedAttributes.Length);
            }
            ...
            if (requiredAttributes != null)
            {
                ...
                _lowLevelStruct.RequiredAttributesLen = NativeULongUtils.ConvertUInt64FromInt32(requiredAttributes.Length);
            }
        }
