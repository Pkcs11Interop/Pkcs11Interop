    ...
    public class CkOtpParam : ICkOtpParam
    {
        ...
        public ulong Type
        {
            get
            {
                ...
                return NativeULongUtils.ConvertUInt64ToUInt64(_lowLevelStruct.Type);
            }
        }
        ...
        public byte[] Value
        {
            get
            {
                ...
                return (_lowLevelStruct.Value == IntPtr.Zero) ? null : UnmanagedMemory.Read(_lowLevelStruct.Value, NativeULongUtils.ConvertUInt64ToInt32(_lowLevelStruct.ValueLen));
            }
        }
        ...
        public CkOtpParam(NativeULong type, byte[] value)
        {
            ...
            if (value != null)
            {
                ...
                _lowLevelStruct.ValueLen = NativeULongUtils.ConvertUInt64FromInt32(value.Length);
            }
        }
