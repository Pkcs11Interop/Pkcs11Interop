    ...
    public class ObjectAttribute : IObjectAttribute
    {
        ...
        public ulong Type
        {
            get
            {
                ...
                return NativeULongUtils.ConvertUInt32ToUInt64(_ckAttribute.type);
            }
        }
        ...
        {
            _ckAttribute = CkaUtils.CreateAttribute(NativeULongUtils.ConvertUInt32FromUInt64(type));
        }
        ...
        {
            _ckAttribute = CkaUtils.CreateAttribute(NativeULongUtils.ConvertUInt32FromUInt64(type), NativeULongUtils.ConvertUInt32FromUInt64(value));
        }
        ...
        {
            _ckAttribute = CkaUtils.CreateAttribute(type, NativeULongUtils.ConvertUInt32FromUInt64(value));
        }
        ...
        public ulong GetValueAsUlong()
        {
            ...
            try
            {
                ...
                return NativeULongUtils.ConvertUInt32ToUInt64(value);
            }
            catch (Exception ex)
            {
        ...
        {
            _ckAttribute = CkaUtils.CreateAttribute(NativeULongUtils.ConvertUInt32FromUInt64(type), value);
        }
        ...
        public ObjectAttribute(ulong type, List<IObjectAttribute> value)
        {
            ...
            _ckAttribute = CkaUtils.CreateAttribute(NativeULongUtils.ConvertUInt32FromUInt64(type), attributes);
        }
        ...
        public ObjectAttribute(ulong type, List<ulong> value)
        {
            ...
            if (value != null)
            {
                ...
                for (int i = 0; i < value.Count; i++)
                    array[i] = NativeULongUtils.ConvertUInt32FromUInt64(value[i]);
            }
            
            _ckAttribute = CkaUtils.CreateAttribute(NativeULongUtils.ConvertUInt32FromUInt64(type), array);
        }
        ...
        public List<ulong> GetValueAsULongList()
        {
            ...
            try
            {
                ...
                if (value != null)
                {
                    ...
                    for (int i = 0; i < value.Length; i++)
                        ulongs.Add(NativeULongUtils.ConvertUInt32ToUInt64(value[i]));
                }
        ...
        public ObjectAttribute(ulong type, List<CKM> value)
        {
            ...
            _ckAttribute = CkaUtils.CreateAttribute(NativeULongUtils.ConvertUInt32FromUInt64(type), mechanisms);
        }
