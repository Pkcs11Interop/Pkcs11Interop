    ...
    public class ObjectAttribute : IObjectAttribute
    {
        ...
        public ulong Type
        {
            get
            {
                ...
                return NativeULongUtils.PutUInt32ToUInt64(_ckAttribute.type);
            }
        }
        ...
        {
            _ckAttribute = CkaUtils.CreateAttribute(NativeULongUtils.GetUInt32FromUInt64(type));
        }
        ...
        {
            _ckAttribute = CkaUtils.CreateAttribute(NativeULongUtils.GetUInt32FromUInt64(type), NativeULongUtils.GetUInt32FromUInt64(value));
        }
        ...
        {
            _ckAttribute = CkaUtils.CreateAttribute(type, NativeULongUtils.GetUInt32FromUInt64(value));
        }
        ...
        public ulong GetValueAsUlong()
        {
            ...
            try
            {
                ...
                return NativeULongUtils.PutUInt32ToUInt64(value);
            }
            catch (Exception ex)
            {
        ...
        {
            _ckAttribute = CkaUtils.CreateAttribute(NativeULongUtils.GetUInt32FromUInt64(type), value);
        }
        ...
        public ObjectAttribute(ulong type, List<IObjectAttribute> value)
        {
            ...
            _ckAttribute = CkaUtils.CreateAttribute(NativeULongUtils.GetUInt32FromUInt64(type), attributes);
        }
        ...
        public ObjectAttribute(ulong type, List<ulong> value)
        {
            ...
            if (value != null)
            {
                ...
                for (int i = 0; i < value.Count; i++)
                    array[i] = NativeULongUtils.GetUInt32FromUInt64(value[i]);
            }
            
            _ckAttribute = CkaUtils.CreateAttribute(NativeULongUtils.GetUInt32FromUInt64(type), array);
        }
        ...
        public List<ulong> GetValueAsULongList()
        {
            ...
            try
            {
                ...
                if (value != null)
                {
                    ...
                    for (int i = 0; i < value.Length; i++)
                        ulongs.Add(NativeULongUtils.PutUInt32ToUInt64(value[i]));
                }
        ...
        public ObjectAttribute(ulong type, List<CKM> value)
        {
            ...
            _ckAttribute = CkaUtils.CreateAttribute(NativeULongUtils.GetUInt32FromUInt64(type), mechanisms);
        }
