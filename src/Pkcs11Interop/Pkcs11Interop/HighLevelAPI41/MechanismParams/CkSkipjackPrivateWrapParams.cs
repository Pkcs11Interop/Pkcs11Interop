    ...
    public class CkSkipjackPrivateWrapParams : ICkSkipjackPrivateWrapParams
    {
        ...
        public CkSkipjackPrivateWrapParams(byte[] password, byte[] publicData, byte[] randomA, byte[] primeP, byte[] baseG, byte[] subprimeQ)
        {
            ...
            if (password != null)
            {
                ...
                _lowLevelStruct.PasswordLen = NativeULongUtils.ConvertUInt32FromInt32(password.Length);
            }
            ...
            if (primeP != null)
            {
                ...
                _lowLevelStruct.PAndGLen = NativeULongUtils.ConvertUInt32FromInt32(primeP.Length);
            }
            ...
            if (baseG != null)
            {
                ...
                _lowLevelStruct.PAndGLen = NativeULongUtils.ConvertUInt32FromInt32(baseG.Length);
            }
            ...
            if (subprimeQ != null)
            {
                ...
                _lowLevelStruct.QLen = NativeULongUtils.ConvertUInt32FromInt32(subprimeQ.Length);
            }
        }
