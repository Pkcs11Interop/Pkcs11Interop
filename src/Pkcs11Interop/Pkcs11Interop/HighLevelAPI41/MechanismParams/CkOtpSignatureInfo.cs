...
namespace Net.Pkcs11Interop.HighLevelAPI41.MechanismParams
{
    ...
    public class CkOtpSignatureInfo : ICkOtpSignatureInfo
    {
        ...
        public CkOtpSignatureInfo(byte[] signature)
        {
            ...
            for (int i = 0; i < NativeULongUtils.PutUInt32ToInt32(_lowLevelStruct.Count); i++)
            {
                ...
                byte[] ckOtpParamValue = UnmanagedMemory.Read(ckOtpParam.Value, NativeULongUtils.PutUInt32ToInt32(ckOtpParam.ValueLen));
